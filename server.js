...
var backendAddress = 'http://' + backendHost + (!backendPort ? "" : ":" + backendPort);
...
app.get('/publications', function(req, res){
  request
    .get(backendAddress + '/publications')
    .end(function(err, data) {
      if(data.status == 403){
        res.send(403, '403 Forbidden');
      } else {
